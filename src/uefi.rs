...
pub struct SimpleTextOutputProtocol {
    pub reset:
        extern "win64" fn(*const SimpleTextOutputProtocol, extended_verification: bool) -> Status,
    output_string: extern "win64" fn(*const SimpleTextOutputProtocol, string: *const u16) -> Status,
    pub test_string:
        extern "win64" fn(*const SimpleTextOutputProtocol, string: *const u16) -> Status,
    query_mode: TODO,
    set_mode: TODO,
    pub set_attribute:
        extern "win64" fn(*const SimpleTextOutputProtocol, attribute: usize) -> Status,
    pub clear_screen: extern "win64" fn(*const SimpleTextOutputProtocol) -> Status,
    pub set_cursor_position:
        extern "win64" fn(*const SimpleTextOutputProtocol, column: usize, row: usize) -> Status,
